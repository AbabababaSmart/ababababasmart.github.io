...
[FlashAttention Releases 页面](https://github.com/Dao-AILab/flash-attention/releases)  
[FlashAttention Releases 页面 2](https://windreamer.github.io/flash-attention3-wheels/)  （更新）
...
这里的 `--hf_overrides` 本质上就是给 `config.json` 打补丁，让 vLLM 能正确解析模型架构。具体这个模型 `--hf-overrides` 这里的设置应该是什么，可以参考 [list-of-multimodal-language-models](https://docs.vllm.ai/en/latest/models/supported_models/?utm_source=chatgpt.com#list-of-multimodal-language-models)

## 参考文献
[1] [vLLM 0.11.0部署Qwen3-VL-4B实战指南](https://blog.csdn.net/weixin_42113456/article/details/155973800) 
[2] [vLLM Docs: modelscope](https://docs.vllm.ai/en/latest/models/supported_models/?h=modelscope#modelscope)
